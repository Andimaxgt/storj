...
func (db *StoragenodeAccounting) GetTallies(ctx context.Context) ([]*accounting.Raw, error) {
...
func (db *StoragenodeAccounting) GetTalliesSince(ctx context.Context, latestRollup time.Time) ([]*accounting.Raw, error) {
